...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # create dict for quick matching of dog names
    dognames_dic = dict()

    # read dog names from txt file into dict
    ...
    # check each image label & classifier label in results_dic againt dognames_dict
    for key in results_dic:
        ...
        # determine if classifier lable is a dog
        classifier_is_dog = 1 if classifier_label in dognames_dic else 0

        # append dog indicatord (index 3: pet_is_dog, index 4: classifier_is_dog)
